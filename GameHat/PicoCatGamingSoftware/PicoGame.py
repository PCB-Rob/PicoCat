...
class PicoGame(SH1106_I2C):
    def __init__(self):
        self.SCREEN_WIDTH = 128
        self.SCREEN_HEIGHT = 64
        self.__up = Pin(19, Pin.IN, Pin.PULL_UP)
        self.__down = Pin(16, Pin.IN, Pin.PULL_UP)
        self.__left = Pin(17, Pin.IN, Pin.PULL_UP)
        self.__right = Pin(18, Pin.IN, Pin.PULL_UP)
        self.__button_A = Pin(13, Pin.IN, Pin.PULL_UP)
        self.__button_B = Pin(12, Pin.IN, Pin.PULL_UP)
        self.__buzzer = PWM(Pin(20))
        
        self.__i2c = I2C(1, sda=Pin(14), scl=Pin(15), freq=400000)
        super().__init__(self.SCREEN_WIDTH, self.SCREEN_HEIGHT, self.__i2c,rotate=180)
